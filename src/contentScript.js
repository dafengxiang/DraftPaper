 ...
 * @LastEditTime: 2024-07-03 17:45:33
...
;(function () {
    try {
        ...
        draftStyleDom.innerHTML = `.draft-drag-border { box-shadow: 0 0 0 2px #f00 !important; } .draft-drag-position { transform: translate(var(--d-dragX,0px), var(--d-dragY,0px)) !important; }`
        ...
        function handleTouchEnd(e) {
            ...
            if (document.execCommand('copy')) {
                ...
                console.info(
                    `${classNames.replace(
                        /draft-drag-position|draft-drag-border/g,
                        ''
                    )}: ${copyRes}`
                )
            }
